    ...
    class HandleClient extends Thread{
        ...
        public void run(){
            try{
                ...
                String previousWindowTitle = "";  // Lưu tên cửa sổ trước đó
       
                while (true) {
                    // Kiểm tra tiêu đề cửa sổ hiện tại
                    String currentWindowTitle = getActiveWindowTitle();  // Hàm giám sát cửa sổ
                    ...
                    if (!currentWindowTitle.equals(previousWindowTitle) && !currentWindowTitle.isEmpty()) {
                        ...
                        // Gửi thông tin cửa sổ hiện tại lên server
                        dout.writeUTF(currentWindowTitle);
                        System.out.println("Chuyển cửa sổ: " + currentWindowTitle);
                    }

                    // Tạm dừng một chút trước lần kiểm tra tiếp theo để tránh tải cao
                    Thread.sleep(1000);
                }
